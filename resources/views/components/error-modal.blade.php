...
<div id="errorModal" class="fixed inset-0 z-50">
    <div class="absolute inset-0 bg-opacity-30 modal-backdrop flex items-center justify-center p-4">
        <div class="modal-content w-full max-w-md overflow-hidden rounded-2xl glassmorphism" role="dialog"
            aria-modal="true" aria-labelledby="errorModalTitle">
            <div class="px-6 pt-6 pb-4">
                <div class="flex flex-col items-center text-center">
                    ...
                    <h3 id="errorModalTitle" class="text-xl font-bold text-gray-900 mb-1">
                        {{ session('errorTitle') ?? 'Erreur détectée' }}</h3>
                    <p class="text-gray-600 mb-6">
                        {{ session('errorMessage') ?? 'Une erreur s\'est produite pendant le traitement de votre demande. Veuillez réessayer.' }}
                    </p>

                    <div class="w-full flex items-center justify-center gap-4">
                        <button type="button"
                            class="modal-close px-6 py-3 bg-premium-error cursor-pointer  text-white hover:text-white font-medium rounded-lg  focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 transition-all duration-300 shadow-md hover:shadow-lg" style="background: var(--error-gradient)">
                            Réessayer
                        </button>
                    </div>
                </div>
            ...
            <button class="absolute top-4 right-4 text-gray-400 hover:text-gray-500 modal-close cursor-pointer" aria-label="Fermer">
