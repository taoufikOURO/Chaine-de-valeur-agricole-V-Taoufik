            ...
            <div class="mb-8 flex justify-between items-center">
                <div>
                    <h1 class="text-4xl font-bold text-gray-900 mb-2 flex items-center">
                        ...
                        Liste des types de parcelles
                    </h1>
                    <p class="text-emerald-600 font-medium ml-16">Visualiser vos parcelles</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm p-6 mb-8 border border-gray-100">
                <div class="flex flex-col sm:flex-row gap-5 justify-between items-start sm:items-center">
                    ...
                    <a href="{{ route('fertilisation.create') }}"
                        ...
                        <i class="fa-solid fa-poop h-5 w-5 transition-transform duration-300 group-hover:rotate-2"></i>
                        <span class="relative z-10">Fertiliser</span>
                    </a>
                            ...
                            <tr class="transition-all duration-300 ease-in-out">
                                ...
                                <td>
                                    <div class="flex gap-2">
                                        ...
                                        @endif
                                        <form id="deleteForm-{{ $parcelle->id }}"
                                            action="{{ route('parcelle.destroy', $parcelle->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button data-id="{{ $parcelle->id }}" type="submit"
