                    ...
                    <div class="mb-8 flex justify-between items-center">
                        <div>
                            <h1 class="text-4xl font-bold text-gray-900 mb-2 flex items-center">
                                Modifier un type de culture
                            </h1>
                            <p class="text-emerald-600 font-medium ml-16">
                                Modifierun type de culture {{ $typeCulture->libelle }}
                            </p>
                        </div>
                    </div>

                    <!-- Enhanced Form -->
                    <form action="{{route('type-culture.update', $typeCulture->id)}}" method="POST"
                        ...
                        <div class="relative bg-gradient-to-b from-white to-gray-50 rounded-xl p-1 shadow-inner">
                            ...
                            <input type="text" required name="libelle" required
                                ...
                                placeholder="Nom du type de culture" value="{{ $typeCulture->libelle }}">
                        </div>
                        @error('libelle')
                            <span id="libelle-error" class="text-red-500 text-xs mb-5">
                                {{ $message }}
                            </span>
                        @enderror
                        <button type="submit"
