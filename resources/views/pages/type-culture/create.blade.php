                    ...
                    <div class="mb-8 flex justify-between items-center">
                        <div>
                            <h1 class="text-4xl font-bold text-gray-900 mb-2 flex items-center">
                                Enregistrer un type de culture
                            </h1>
                            <p class="text-emerald-600 font-medium ml-16">Ajoutez un nouveau type de culture à votre
                                inventaire</p>
                        </div>
                    </div>

                    <!-- Enhanced Form -->
                    <form action="{{ route('type-culture.store') }}" method="POST"
                        ...
                        <div class="relative bg-gradient-to-b from-white to-gray-50 rounded-xl p-1 shadow-inner">
                            ...
                            <input type="text" required name="libelle" required
                                ...
                                placeholder="Nom du type de culture">
                        </div>
                        @error('libelle')
