                    ...
                    <div class="mb-8 flex justify-between items-center">
                        <div>
                            ...
                            <p class="text-emerald-600 font-medium ml-16">
                                Fertilisez une parcelle de votre choix
                            </p>
                        </div>
                    </div>

                    <!-- Enhanced Form -->
                    <form action="{{ route('fertilisation.store') }}" method="POST"
                        ...
                        <div class="relative bg-gradient-to-b from-white to-gray-50 rounded-xl p-1 shadow-inner">
                            ...
                            <textarea required name="description" id="description"
                                class="w-full pl-10 pr-4 py-3.5 rounded-xl border-0 ring-1 ring-gray-200 focus:ring-2 focus:border bg-transparent transition duration-200"
                                placeholder="Description de la fertilisation"></textarea>
                        </div>
                        @error('description')
                        ...
                        <button type="submit"
                            ...
                            <span class="relative">Fertilisation de la parcelle</span>
                        </button>
                    </form>
                </div>
            </div>
