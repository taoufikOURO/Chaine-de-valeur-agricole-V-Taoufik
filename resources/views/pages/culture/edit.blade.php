                ...
                <div class="max-w-4xl mx-auto">
                    <div class="mb-8 flex justify-between items-center">
                        <div>
                            ...
                            <p class="text-emerald-600 font-medium ml-16">Modifier la culture {{$culture->nom}}</p>
                        </div>
                    </div>
                    ...
                    <form action="{{ route('culture.update', $culture->id) }}" method="POST"
                        ...
                        <div class="relative bg-gradient-to-b from-white to-gray-50 rounded-xl p-1 shadow-inner">
                            ...
                            <select type="text" required name="type_culture_id" required
                                ...
                                <option value="" disabled selected> Veuillez sélectionnez un type de culture </option>
                        ...
                        <div class="relative bg-gradient-to-b from-white to-gray-50 rounded-xl p-1 shadow-inner">
                            ...
                            <input type="text" required name="nom" required value="{{$culture->nom ?? ''}}"
                                class="w-full pl-10 pr-4 py-3.5 rounded-xl border-0 ring-1 ring-gray-200 focus:ring-2 focus:border bg-transparent transition duration-200"
