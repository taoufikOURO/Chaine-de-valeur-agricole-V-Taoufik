...
@section('content')
    ...
    <body class="min-h-screen flex items-center justify-center p-4 sm:p-6 md:p-8">
        <div class="relative max-w-4xl w-full bg-white rounded-3xl shadow-profile overflow-hidden">
            <!-- Motifs décoratifs -->
            ...
            <div class="relative z-10 p-6 sm:p-8 md:p-10 grid md:grid-cols-3 gap-8">
                ...
                <div class="md:col-span-1 flex flex-col items-center md:items-start">
                    ...
                    <div class="flex items-center text-gray-600 mb-6">
                        <svg class="w-5 h-5 mr-2 text-agri-green-500" viewBox="0 0 24 24" fill="none"
                ...
                <div class="md:col-span-2">
                    <div class="mb-8">
                        <div class="flex items-center mb-4">
                            <span class="text-agri-green-500 mr-2">
                            ...
                            <h2 class="text-xl font-semibold text-gray-800">À propos</h2>
                        </div>
                        <p class="text-gray-600 leading-relaxed">
                            Agriculteur bio passionné depuis 15 ans, spécialisé dans les cultures maraîchères biologiques et
                            les vergers. Engagé dans l'agriculture durable et raisonnée. Mon exploitation s'étend sur 42
                            hectares où je cultive principalement des fruits et légumes bio de saison.
                        </p>
                    </div>
                    ...
                    <div class="flex flex-wrap gap-2">
                        <span class="px-3 py-1 bg-agri-green-100 text-agri-green-700 rounded-full text-sm">Fraises</span>
                        <span class="px-3 py-1 bg-agri-green-100 text-agri-green-700 rounded-full text-sm">Cerises</span>
                        <span class="px-3 py-1 bg-agri-green-100 text-agri-green-700 rounded-full text-sm">Pommes</span>
                        <span class="px-3 py-1 bg-agri-green-100 text-agri-green-700 rounded-full text-sm">Tomates</span>
                        <span
                            class="px-3 py-1 bg-agri-green-100 text-agri-green-700 rounded-full text-sm">Courgettes</span>
                        <span class="px-3 py-1 bg-agri-green-100 text-agri-green-700 rounded-full text-sm">Carottes</span>
                        <span class="px-3 py-1 bg-agri-green-100 text-agri-green-700 rounded-full text-sm">Pommes de
                            terre</span>
                        <span class="px-3 py-1 bg-agri-green-100 text-agri-green-700 rounded-full text-sm">Salades</span>
                    </div>
                </div>
            </div>
                ...
                <div class="p-6 flex flex-col sm:flex-row justify-between items-center">
                    <div class="text-gray-600 text-sm">
                        <span class="inline-flex items-center">
                            <svg class="w-4 h-4 mr-1 text-agri-green-500" viewBox="0 0 24 24" fill="none"
                                stroke="currentColor" stroke-width="2">
                                <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path>
                            </svg>
                            Membre de la Coopérative Agricole Régionale
                        </span>
                    </div>

                    <div class="mt-4 sm:mt-0">
                        <button
                            class="inline-flex items-center px-4 py-2 bg-agri-green-500 hover:bg-agri-green-600 text-white rounded-lg transition duration-300 ease-in-out shadow-sm">
